...
ActiveRecord::Schema.define(version: 2021_04_07_145804) do
  ...
  create_table "auth_sources", id: :integer, force: :cascade do |t|
  ...
  create_table "boards", id: :integer, force: :cascade do |t|
  ...
  create_table "changes", id: :integer, force: :cascade do |t|
  ...
  create_table "changesets", id: :integer, force: :cascade do |t|
  ...
  create_table "custom_field_enumerations", id: :integer, force: :cascade do |t|
  ...
  create_table "custom_values", id: :integer, force: :cascade do |t|
  ...
  create_table "email_addresses", id: :integer, force: :cascade do |t|
  ...
  create_table "enabled_modules", id: :integer, force: :cascade do |t|
  ...
  create_table "import_items", id: :integer, force: :cascade do |t|
  ...
  create_table "issue_categories", id: :integer, force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
    t.string "name", limit: 60, default: "", null: false
  ...
  create_table "issue_relations", id: :integer, force: :cascade do |t|
  ...
  create_table "issue_statuses", id: :integer, force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
  ...
  create_table "journal_details", id: :integer, force: :cascade do |t|
  ...
  create_table "journals", id: :integer, force: :cascade do |t|
  ...
  create_table "member_roles", id: :integer, force: :cascade do |t|
  ...
  create_table "news", id: :integer, force: :cascade do |t|
    t.integer "project_id"
  ...
  create_table "open_id_authentication_associations", id: :integer, force: :cascade do |t|
    t.integer "issued"
    t.integer "lifetime"
    t.string "handle"
    t.string "assoc_type"
  ...
  create_table "open_id_authentication_nonces", id: :integer, force: :cascade do |t|
  ...
  create_table "time_entries", id: :integer, force: :cascade do |t|
    t.integer "project_id", null: false
    t.integer "user_id", null: false
    t.integer "issue_id"
  ...
  create_table "watchers", id: :integer, force: :cascade do |t|
  ...
  create_table "wiki_content_versions", id: :integer, force: :cascade do |t|
  ...
  create_table "wiki_contents", id: :integer, force: :cascade do |t|
    t.integer "page_id", null: false
    t.integer "author_id"
    t.text "text"
    t.string "comments", limit: 1024, default: ""
  ...
  create_table "wiki_pages", id: :integer, force: :cascade do |t|
  ...
  create_table "wiki_redirects", id: :integer, force: :cascade do |t|
    t.integer "wiki_id", null: false
    t.string "title"
